...
class RetrieveOperations:  # pylint: disable=docstring-missing-param
    ...
    def stream(
        ...
        deserialized: Stream[Union[_models1.PartialResult, _models1.FinalResult]] = Stream(response=response, deserialization_callback=_callback, terminal_event="[DONE]", last_event_id=_last_event_id, reconnect_callback=_reconnect)  # type: ignore
        if cls:
