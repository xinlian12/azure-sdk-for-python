...
class UnnamedOperations:  # pylint: disable=docstring-missing-param
    ...
    def receive(self, **kwargs: Any) -> Stream[_models1.Info]:
        ...
        deserialized: Stream[_models1.Info] = Stream(response=response, deserialization_callback=_callback, last_event_id=_last_event_id, reconnect_callback=_reconnect)  # type: ignore
        if cls:
