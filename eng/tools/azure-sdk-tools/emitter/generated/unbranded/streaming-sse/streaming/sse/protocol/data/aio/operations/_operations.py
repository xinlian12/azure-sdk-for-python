...
from ...operations._operations import (
    ...
    build_protocol_data_without_envelope_request,
)
...
class ProtocolDataOperations:  # pylint: disable=docstring-missing-param
    ...
    async def with_envelope(self, **kwargs: Any) -> AsyncStream[Union[str, _models2.WithEnvelope1]]:
        """with_envelope.

        :return: An instance of AsyncStream that iterates over str or WithEnvelope1
        :rtype: ~streaming.sse.AsyncStream[str or ~streaming.sse.protocol.data.models.WithEnvelope1]
        ...
        cls: ClsType[AsyncStream[Union[str, _models2.WithEnvelope1]]] = kwargs.pop("cls", None)
        ...
        def _callback(_http_response, _event):
            if _event.event == "withEnvelope":
                ...
                deserialized = _deserialize(_models2.WithEnvelope1, _event_json)
            else:
    ...
    async def without_envelope(self, **kwargs: Any) -> AsyncStream[Union[str, _models2.WithEnvelope1]]:
        """without_envelope.
